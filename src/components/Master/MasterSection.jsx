                ...
                <div className="master-section-wrapper">
                    ...
                    <div className="master-section-text">
                        ...
                        <p
                            ...
                            "
                        >
                            Если вы обладаете уникальными знаниями или навыками,
                            хотите обучать людей своему ремеслу и зарабатывать
                            на этом - добро пожаловать!
                        </p>
                        <Link
                            to="/master"
