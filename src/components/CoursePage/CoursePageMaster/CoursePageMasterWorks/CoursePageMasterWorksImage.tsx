...
const CoursePageMasterWorksImage: React.FC = () => {
	...
	const {
		works: { isOpenImage, currentUrlImage },
	...
	return (
		...
		>
			...
			>
				<div className="course-page-master-works-modal-image-content-image" style={{ backgroundImage: `url("${process.env.REACT_APP_IMAGE_DOMEN}/${currentUrlImage}")` }}></div>
			</div>
		</div >
	);
};
