			...
			<div className="container">
				<div className="course-page-works-wrapper">
					...
					<div className="course-page-works-slider-wrapper">
						<button className="course-page-works-slider__btn prev" onClick={onClickPrev}>
						...
						<Slider {...settings} ref={SliderRef} className='course-page-works-slider'>
						...
						<button className="course-page-works-slider__btn next" onClick={onClickNext}>
							<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
