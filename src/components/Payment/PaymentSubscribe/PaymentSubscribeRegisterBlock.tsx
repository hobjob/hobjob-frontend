...
const PaymentSubscribeRegisterBlock: React.FC<
    PaymentSubscribeRegisterBlockProps
> = ({
    setYearSubscribe,
    isYearSubscribe,
    isCheckbox,
    ...
    return (
        <>
            {isCheckbox ? (
                <div className="payment-subscribe-checkbox-block-wrapper">
                    <div
            ...
            <div className="payment-subscribe-block">
                <div className="payment-subscribe-block-text">
                    {isPrologation ? (
                        typeSubscribe === "year-subscribe" ? (
                            <>
                    ...
                    <div className="payment-subscribe-block-text-list">
                        ...
                        <a
                            ...
                            className="payment-subscribe-block-text-list-hobjob-good"
                        >
                            <svg
                                width="17"
                                height="15"
                            ...
                            <div className="payment-subscribe-block-text-list-hobjob-good-text">
                                <img
                                    src={`${process.env.REACT_APP_IMAGE_DOMEN}/all/hobjob-good.svg`}
                                    alt=""
                                    className="payment-subscribe-block-text-list-hobjob-good-text__logo"
                                />
                                <p className="payment-subscribe-block-text-list-hobjob-good-text__text">
...
export default PaymentSubscribeRegisterBlock;
