...
interface ReglogSubscribeBlockProps {
	type: string;
}

const ReglogSubscribeBlock: React.FC<ReglogSubscribeBlockProps> = ({ type }) => {
	return (
			...
			<div className="reglog-product-subscribe-block-text">
				{type === "test" ? (
					<>
						<h2 className="reglog-product-subscribe-block-text__title">
							Получите доступ к курсу по подписке
						</h2>
						<p className="reglog-product-subscribe-block-text__pricedesc">
							Первый месяц за 1₽, далее 299₽ в месяц
						</p>
					</>
				) : (
					<h2 className="reglog-product-subscribe-block-text__title">
						{rates[type].subtitle} за {rates[type].fullPrice}₽
					</h2>
				)}
				...
				<div className="reglog-product-subscribe-block-text-list">
					...
					<a
						...
						className="reglog-product-subscribe-block-text-list__item"
					>
						<svg
							viewBox="0 0 17 15"
							fill="none"
