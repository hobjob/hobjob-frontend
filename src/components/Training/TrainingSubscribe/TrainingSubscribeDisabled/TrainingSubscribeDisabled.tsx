...
interface TrainingSubscribeDisabledProps {
    isAnimationShake: boolean;
    subtitle: string;
    title: string;
    price?: string;
    btnText: string;
...
const TrainingSubscribeDisabled: React.FC<TrainingSubscribeDisabledProps> = ({
    isAnimationShake,
    subtitle,
    title,
    price,
    ...
    return (
        <div
            className={`training-disabled-subscribe ${
                isAnimationShake ? "shake" : ""
            }`}
        >
                <p className="training-disabled-subscribe__subtitle">
                    {subtitle}
                </p>
                <h3 className="training-disabled-subscribe__title">
                    {title}
                </h3>

                {price ? (
                    <p className="training-disabled-subscribe__price">
                        {price}
                    </p>
                ) : null}

                <div className="training-disabled-subscribe-list">
                    <p className="training-disabled-subscribe-list__item">
                        <svg
                            viewBox="0 0 17 15"
                            fill="none"
                    ...
                    <a
                        ...
                        className="training-disabled-subscribe-list__item"
                    >
                        <svg
                            viewBox="0 0 17 15"
                            fill="none"
                ...
                <button
                    className="btn training-disabled-subscribe__btn"
