...
import {UserInfoCourseSubscribe} from "../../../models/User/IUserInfo";
import {Master} from "../../../models/IMaster";

interface TrainingBlockProps extends UserInfoCourseSubscribe {
...
const TrainingSubscribeBlock: React.FC<TrainingBlockProps> = ({
    ...
    return (
        <div
            className="training-section-block"
            onClick={isWorkSubscribe ? () => {} : onClickVisibleDisabled}
        >
            <Link
                to={
                    isWorkSubscribe
                        ? `/go/passing/${courseId}/1`
                        : `/go/training`
                }
...
export default TrainingSubscribeBlock;
