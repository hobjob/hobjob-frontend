...
const AboutSection = ({buttonVisible}) => {
                    ...
                    <div className="about-section-right">
                        <div className="about-section-text">
                            <p
                                ...
                                "
                            >
                                HobJob - это сообщество творческих людей. На
                                нашей платформе представлены курсы мастеров
                                своего дела. Они учат тому, что умеют лучше
                                всего - творить.
                            </p>
                            {buttonVisible ? (
                                <Link
