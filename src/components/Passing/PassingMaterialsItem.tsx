...
const PassingMaterialsItem: React.FC<PassingMaterialsItemProps> = ({
	...
	return (
		<div
			...
			className="passing-lesson-info-materials-item"
		>
			<div className="passing-lesson-info-materials-item-icon">
				<svg
					width="20"
					height="20"
					viewBox="0 0 20 20"
			...
			<p className="passing-lesson-info-materials-item__title">
				{title}
			</p>
		</div>
	);
