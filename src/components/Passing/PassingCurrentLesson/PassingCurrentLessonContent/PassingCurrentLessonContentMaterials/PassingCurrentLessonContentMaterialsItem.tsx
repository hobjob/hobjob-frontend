...
interface PassingCurrentLessonContentMaterialsItemProps extends PassingCourseLessonMaterial {
	download: (index: number) => void
	index: number
}

const PassingCurrentLessonContentMaterialsItem: React.FC<PassingCurrentLessonContentMaterialsItemProps> = ({ download, title, index }) => {
	...
	return (
		<div className='passing-current-lesson-content-materials-item' onClick={onClickDownload}>
			<div className="passing-current-lesson-content-materials-item-icon">
				<svg
					width="20"
					height="20"
					viewBox="0 0 20 20"
			...
			<p className="passing-current-lesson-content-materials-item__title">
				{title}
			</p>

			{isDownloading ? <span className="passing-current-lesson-content-materials-item__loader"></span> : null}
		</div>
	)
}

export default PassingCurrentLessonContentMaterialsItem