            ...
            <div className="container">
                <div className="master-wrapper">
                    <div className="master-cart-info">
                        ...
                        <div className="master-cart-info-text">
                            ...
                            <p className="master-cart-info-text__description">
                                Ameskeria помогает мне объединить мои творческие
                                заботы: в основном вязание крючком и фотография.
                            </p>

                            <div className="master-cart-info-text-specialty">
                                <span
                                    className="
                                        master-cart-info-text-specialty__subspan
                                    "
                                >
                                    Специалность:
                                </span>
                                <span
                                    className="
                                        master-cart-info-text-specialty__specialty
                                    "
                                >
                    ...
                    <div className="master-course">
                        <h2 className="title__mb master-course__title">Курсы</h2>
                    ...
                    <div className="master-magazine">
                        <h2 className="title__mb master-magazine__title">Журнал</h2>
